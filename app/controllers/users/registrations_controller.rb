...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def destination_params
    params.require(:destination).permit(:d_first_name,:d_family_name,:d_first_name_kana,:d_family_name_kana,:post_code,:prefecture_code,:city,:house_number,:bilding_name,:phone_number)
  end
